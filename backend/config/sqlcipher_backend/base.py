...
from django.db.backends.sqlite3.base import DatabaseWrapper as SQLiteDatabaseWrapper, adapt_date, adapt_datetime, decoder, FORMAT_QMARK_REGEX
...
from cloud.db_security import key_pragma, normalize_key
import os
...
class DatabaseWrapper(SQLiteDatabaseWrapper):
    ...
    def get_new_connection(self, conn_params):
        ...
        try:
            connection.execute(key_pragma(normalize_key(os.getenv("FUCKSEATS_CLOUD_DB_KEY"))))
